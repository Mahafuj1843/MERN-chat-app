                        ...
                        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <div className="space-y-4 md:space-y-6">
                                <div className='flex md:justify-between gap-4'>
                                    <div className='w-1/2'>
                                        <label for="fname" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Firstname</label>
                                        <input ref={(i) => fname = i} type="text" name="fname" id="fname" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-[#0C7075] focus:border-[#0C7075] block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-[#11898f] dark:focus:border-blue-500" placeholder="e.g. John" required="" />
                                    </div>
                                    <div className='w-1/2'>
                                        <label for="lname" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Lastname</label>
                                        <input ref={(i) => lname = i} type="text" name="lname" id="lname" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-[#0C7075] focus:border-[#0C7075] block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-[#11898f] dark:focus:border-blue-500" placeholder="e.g. Doe" required="" />
                                    </div>
                                </div>
                                <div>
                                    <label for="email" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your email</label>
                                    <input ref={(i) => email = i} type="email" name="email" id="email" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-[#0C7075] focus:border-[#0C7075] block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-[#11898f] dark:focus:border-blue-500" placeholder="name@company.com" required="" />
                                </div>
                                <div>
                                    ...
                                    <div class="relative w-full">
                                        ...
                                        <input ref={(i) => password = i} type={show ? "text" : "password"} name="password" id="password" placeholder="••••••••" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-[#0C7075] focus:border-[#0C7075] block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-[#0C7075] dark:focus:border-[#127f85]" required="" />
                                    </div>
                                </div>
                                <div className="flex items-start">
                                    <div className="flex items-center h-5">
                                        <input id="terms" aria-describedby="terms" type="checkbox" className="checkbox w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-[#57cbd1] dark:bg-gray-700 dark:border-[#0C7075] dark:focus:ring-[#0C7075] dark:ring-offset-gray-800" required="" />
                                    </div>
                                    <div className="ml-3 text-sm">
                                        <label for="terms" className="font-medium text-gray-500 dark:text-gray-300">Remember me </label>
                                    </div>
                                </div>
                                <button onClick={onRegister} type="submit" className="w-full text-white bg-[#0C7075] hover:bg-[#157c81] focus:ring-4 focus:outline-none focus:ring-[#38b9c0] font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-[#0C7075] dark:hover:bg-[#16898f] dark:focus:ring-[#0f6064]">Create an account</button>
                                <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                                    Already have an account? <Link to="/" className="font-medium text-[#0C7075] hover:underline dark:text-[#2f878b]">Login here</Link>
                                </p>
                            </div>
                        </div>
                    </div>
