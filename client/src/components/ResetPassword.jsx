                        ...
                        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <div className="space-y-4 md:space-y-6" action="#">
                                <div>
                                    ...
                                    <input ref={(i) => npassword = i} type="password" name="password" id="password" placeholder="••••••••" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-[#0C7075] focus:border-[#0C7075] block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-[#15979e] dark:focus:border-[#0e8086]" required="" />
                                </div>
                                <div>
                                    <label for="Cpassword" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Confirm Password</label>
                                    <input ref={(i) => cpassword = i} type="password" name="Cpassword" id="Cpassword" placeholder="••••••••" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-[#0C7075] focus:border-[#0C7075] block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-[#128f96] dark:focus:border-[#108086]" required="" />
                                </div>
                                <button onClick={onReset} type="submit" className="w-full text-white bg-[#0C7075] hover:bg-[#148e94] focus:ring-4 focus:outline-none focus:ring-[#4ebac0] font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-[#0C7075] dark:hover:bg-[#1b7e83] dark:focus:ring-[#199fa7]">Save</button>
                                <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                                    Already have an account? <Link to="/" className="font-medium text-[#0C7075] hover:underline dark:text-primary-500">Login here</Link>
                                </p>
                            </div>
                        </div>
                    </div>
