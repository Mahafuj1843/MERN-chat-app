        ...
        <Fragment>
            <div className="flex justify-between bg-[#0C7075] px-4 py-2 z-10">
                <div className="logo flex items-center cursor-pointer">
                    ...
                    <span class="text-2xl font-bold text-white dark:text-white">Instachat.</span>
                </div>
                <div className="flex items-center space-x-3 lg:space-x-8">
                    ...
                    <div className="dropdown dropdown-end dropdown-hover">
                        <img tabIndex={0} src={getUserDetails().photo} className="rounded-full h-12 w-12 object-fill" alt="Profile Image" />
                        ...
                        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                            <div className="space-y-4 md:space-y-6">
                                <div className="profile flex justify-center ">
                                    <img ref={(i) => imageView = i} src={ProfileData.photo} className="w-24 h-24 object-cover rounded-full" alt="Profile image" />
