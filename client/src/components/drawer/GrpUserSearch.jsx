    ...
    return (
        <Fragment >
            <aside class="fixed h-full w-full z-50 left-0 top-0 transition duration-300 ease-in-out" style={{ display: showGUS ? 'block' : 'none' }}>
                ...
                <div class="fixed h-full w-3/4 md:w-2/6 xl:w-1/5 left-0 top-0 bg-white shadow-lg pt-4 p-x2 transition duration-700 ease-in-out" style={{ left: showGUS ? '0%' : '100%' }}>
                    <h2 class="px-5 text-lg font-medium text-gray-800 dark:text-white">Create Group</h2 >
                    <div className='my-4 px-5'>
                        <input ref={(i) => name = i} type="text" name="grpName" id="grpName" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-[#0C7075] focus:border-[#1c9096] block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-[#0C7075] dark:focus:border-[#1aa3aa]" placeholder="Group Name" required="" />
                    </div>
                    <div class="my-4 px-5">
                        <input ref={(i) => search = i} onChange={onHandleSearch} type="search" id="search" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-[#0C7075] focus:border-[#269ba1] block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-[#0C7075] dark:focus:border-[#16969c]" placeholder="Search User..." required />
                    </div>
                    <div class="mt-2 mx-5 flex gap-2 h-fit border-y overflow-x-auto">
                        {
                            selectForGrp?.map((user, i) => {
                                return(
                                    <button onClick={onAddtoGrp.bind(this, user)} className="flex flex-col w-fit py-2 transition-colors duration-200 dark:hover:bg-gray-800 gap-x-2 focus:outline-none">
