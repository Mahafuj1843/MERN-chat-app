        ...
        <Fragment>
            {
                ...
                <div class="flex flex-col space-y-4 w-full h-auto py-4 px-5 xl:px-14 bg-black-rgba scroller overflow-x-hidden overflow-y-auto flex-grow">
                    <Message />
                </div>

                <div class="flex flex-none space-x-2 items-center bg-white px-6 py-2 border-t">
                    ...
                    <div class="flex flex-grow items-center space-x-4 ">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 64 64" style={{ isolation: "isolate" }} id="send"><defs><clipPath id="a"><rect width="64" height="64"></rect></clipPath></defs><g clip-path="url(#a)">
                            <path fill="text-gary-700"
