...
const ChatBox = () => {
  return (
    <Fragment>
        <div class="flex flex-col bg-[#0b141a] overflow-hidden flex-grow"
                ...
                <div class="flex justify-between bg-[#202c33] px-4 py-2">
                    <div class="flex flex-none space-x-2 items-center">
                        ...
                        <div class="flex flex-col">
                            <span class="font-bold text-[#e9edef]">Flyod Miles</span>
                            <span class="text-sm text-[#aebac1]">en ligne le 19/05/2022 à 15:56</span>
                        </div>
                    </div>
                ...
                <div class="flex flex-none space-x-2 items-center bg-[#202c33] px-6 py-2">
                    ...
                    <div class="flex flex-grow items-center space-x-4 ">
                        <input type="text"
                            class="focus:outline-none bg-[#2a3942] w-full text-[#aebac1] p-3 rounded-lg text-sm"
