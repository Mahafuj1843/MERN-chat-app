                        ...
                        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <div className="space-y-4 md:space-y-6" action="#">
                                <div>
                                    ...
                                    <input ref={(i) => email = i} type="email" name="email" id="email" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-[#0C7075] focus:border-[#0C7075] block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-[#14898f] dark:focus:border-[#14949b]" placeholder="name@company.com" required="" />
                                </div>
                                <button onClick={onSend} type="submit" className="w-full text-white bg-[#0C7075] hover:bg-[#138288] focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-[#0C7075] dark:hover:bg-primary-700 dark:focus:ring-[#147479]">Send Password Reset Mail</button>
                                <p className="text-sm font-light text-gray-500 dark:text-gray-400">
                                    Don’t have an account yet? <Link to="/register" className="font-medium text-[#0C7075] hover:underline dark:text-[#39999e]">Sign up</Link>
                                </p>
                            </div>
                        </div>
                    </div>
